...
public class ProbabilityHybridCoba extends RandomSpeedBase {
    ...
    public ProbabilityHybridCoba(int nodes, double x, double y, double duration, double ignore, long randomSeed, double interval, double minspeed, double maxspeed) {
    ...
    public ProbabilityHybridCoba(String[] args) {
        go(args);
    }
    ...
    public ProbabilityHybridCoba(String args[], Scenario _pre, Integer _transitionMode) {
