...
import edu.bonn.cs.iv.bonnmotion.models.da.*;
import edu.bonn.cs.iv.util.PositionHashMap;
import edu.bonn.cs.iv.util.IntegerHashMap;

/**
 * Application to create movement scenarios according to the Disaster Area
 * model.
 */
public class DisasterAreawithProbHybrid extends RandomSpeedBase {
    ...
    public DisasterAreawithProbHybrid(int nodes, double x, double y, double duration, double ignore, long randomSeed, double minspeed, double maxspeed, double maxpause, double maxdist, double avgMobileNodesPerGroup, double groupSizeDeviation, double pGroupChange) {
    ...
    public DisasterAreawithProbHybrid(String[] args) {
...
//            for (int i = 0; i < catastropheAreas.length; i++) {
//                LinkedList<Position> src = determineway(catastropheAreas[i]);
//            }
            Position src = DetRandDst(catastropheAreas[ref.belongsto].getBounds().x,
                    catastropheAreas[ref.belongsto].getBounds().x + catastropheAreas[ref.belongsto].getBounds().width,
                    catastropheAreas[ref.belongsto].getBounds().y + catastropheAreas[ref.belongsto].getBounds().height,
                    catastropheAreas[ref.belongsto].getBounds().y, catastropheAreas[ref.belongsto]);
            ...
            while (t < parameterData.duration) {
                ...
                /**
                 * * pause time for each group at the beginning to avoid sets
                 * of groups **
                 */
                if (t == 0.0) {
...
//            src = group.positionAt(t).add(getInitialLocation());
    ...
    /**
     * Processes all arguments that depend on each other in some way that were
     * skipped parseArg(char, String)
     */
                            ...
                            if (movePhase == 1) {
                                ...
                                if (movePhase == 2) {
                                    ...
                                    for (int i = 0; i < (area.allways.get(PosInList)).size(); i++) {
                                        ...
                                        if (rand >= 0.1) {//to area 2
                                            dst = new Position(55, 450);
                                            cycle.add(dst);
//                                            ++movePhase;
                                        } else if (rand >= 0.2) {//to area 3
                                            dst = new Position(55, 55);
                                            cycle.add(dst);
//                                            ++movePhase;
                                        } else if (rand >= 0.3) {//to area 0
                                            dst = new Position(450, 450);
                                            cycle.add(dst);
//                                            ++movePhase;
                                        } else if (rand >= 0.4) {//to area 1
                                            dst = new Position(55, 450);
                                            cycle.add(dst);
//                                            ++movePhase;
                                        }
                                    ...
                                    if (movePhase == 3) {
                                        ...
                                        for (int i = (area.allways.get(PosInList)).size(); i >= 0; i--) {
                                            double rand = Math.random();
                                            if (rand >= 0.1) {//to area 3
                                                dst = new Position(55, 55);
                                                cycle.add(dst);
//                                                ++movePhase;
                                            } else if (rand >= 0.4) {//to area 2
                                                dst = new Position(450, 55);
                                                cycle.add(dst);
//                                                ++movePhase;
                                            } else if (rand >= 0.5) {//to area 0
                                                dst = new Position(450, 450);
                                                cycle.add(dst);
//                                                ++movePhase;
                                            } else if (rand >= 0.6) {//to area 1
                                                dst = new Position(55, 450);
                                                cycle.add(dst);
//                                                ++movePhase;
                                            }
...
//                                            ++movePhase;
                                            ...
                                            cycle.add(dst);
//                                            ++movePhase;
                                        } else if (Math.random() >= 0.5) {//to area 3
                                            dst = new Position(55, 55);
                                            cycle.add(dst);
//                                            ++movePhase;
                                        } else if (Math.random() >= 0.5) {//to area 0
                                            dst = new Position(450, 450);
                                            cycle.add(dst);
//                                            ++movePhase;
                                        }
                                ...
                                if (movePhase == 2) {
                                    ...
                                    for (int i = 0; i < (area.allways.get(PosInList)).size(); i++) {
                                        ...
                                        if (rand >= 0.1) {//to area 3
                                            ...
                                            dst = new Position(450, 450);
                                            cycle.add(dst);
                                        } else if (rand >= 0.3) {//to area 1
                                            dst = new Position(55, 450);
                                            cycle.add(dst);
                                        } else if (rand >= 0.3) {//to area 2
                                            dst = new Position(450, 55);
                                            cycle.add(dst);
                                        }
                                    }
                                    ...
                                    if (movePhase == 3) {
                                        ...
                                        if (movePhase == 4) {
                                            ...
                                            for (int i = (area.allways.get(PosInList)).size(); i >= 0; i--) {
                                                double rand = Math.random();
                                                if (rand >= 0.1) {//to area 0
                                                    dst = new Position(450, 450);
                                                    cycle.add(dst);
                                                } else if (rand >= 0.2) {//to area 2
                                                    dst = new Position(450, 55);
                                                    cycle.add(dst);
                                                } else if (rand >= 0.3) {//to area 3
                                                    dst = new Position(55, 55);
                                                    cycle.add(dst);
                                                } else if (rand >= 0.4) {//to area 1
                                                    dst = new Position(55, 450);
                                            ...
                                            if (movePhase == 5) {
                                                ...
                                                for (int i = (area.allways.get(PosInList)).size(); i >= 0; i--) {
                                                    ...
                                                    if (rand >= 0.1) {//to area 2
                                                        ...
                                                        dst = new Position(55, 55);
                                                        cycle.add(dst);
                                                    } else if (rand >= 0.4) {//to area 0
                                                        dst = new Position(450, 450);
                                                        cycle.add(dst);
                                                    } else if (rand >= 0.2) {//to area 1
                                                        dst = new Position(55, 450);
                                                        cycle.add(dst);
                                                    }
                                                }
