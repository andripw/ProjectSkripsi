 ...
 * model.
 */
public class DisasterAreawithRandom extends RandomSpeedBase {
    ...
    public DisasterAreawithRandom(int nodes, double x, double y, double duration, double ignore, long randomSeed, double minspeed, double maxspeed, double maxpause, double maxdist, double avgMobileNodesPerGroup, double groupSizeDeviation, double pGroupChange) {
    ...
    public DisasterAreawithRandom(String[] args) {
